...
from openrl.analyzers import ValNetPredictionAnalyzer
from openrl.common import Lazy, logging_utils
from openrl.common.gpu_utils import get_gpu_memory, wait_for_memory_release
...
class ActionRankingAnalyzer(ValNetPredictionAnalyzer):
    ...
    def _convert_alt_cont_results_to_states(
        ...
        for res in alt_cont_results:
            ...
            tree = json.loads(res["_openrl__reasoning_tree"])
