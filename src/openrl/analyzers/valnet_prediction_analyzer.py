...
from openrl.analyzers.analyzer import Analyzer
...
from openrl.common.wandb_utils import save_inference_result_to_cloud
from openrl.reward_functions import RewardFunction
from openrl.inference_strategies import InferenceStrategy
from openrl.tasks import Task
from openrl.common import Tokenizer
from openrl.trainers.policy_trainer import PolicyTrainer
...
class ValNetPredictionAnalyzer(Analyzer):
    def __init__(
        ...
        **kwargs,
        ...
        from openrl.runtime.policy_iteration_runtime import PolicyIterationRuntime
    ...
    def _analyze_checkpoint(
        ...
        for res in tqdm(results, desc="Computing ground truth mc values"):
            ...
            assert res["query"] == json.loads(res["_openrl__reasoning_tree"])["text"]
            assert data_instance[self.problem_field] in res["query"]

            continuations = res["_openrl__candidate_answers"]
        ...
        unnecessary_columns = [
            "_openrl__candidate_answers",
            "_openrl__reasoning_tree",
        ]
    ...
    def _compute_mc_value(
        ...
        *,
        ...
        tree = json.loads(value_estimation_result["_openrl__reasoning_tree"])
