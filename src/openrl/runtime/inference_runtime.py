...
from openrl.common import JsonDict, Lazy, Params, logging_utils
from openrl.inference_strategies import InferenceStrategy
from openrl.runtime.base_runtime import BaseRuntime, Runtime
...
class InferenceRuntime(BaseRuntime):
    ...
    def generate(self):
        ...
        from openrl.common.py_utils import is_world_process_zero
