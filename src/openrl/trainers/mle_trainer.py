...
from openrl.trainers import Trainer
from openrl.trainers.policy_trainer import PolicyTrainer
from openrl.trainers.utils import entropy_from_logits, masked_mean
...
class MaximumLikelihoodTrainer(PolicyTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        if "data_collator" not in kwargs:
            kwargs["data_collator"] = MLEDataCollator()
    ...
    def compute_loss(
        ...
        loss, metrics = self.compute_lm_loss(logits, labels, advantages)
    ...
    def compute_lm_loss(
        ...
        metrics = {"logit_entropy": mean_entropy}
        ...
        if advantages is not None:
            ...
            metrics["advantage"] = mean_advantage
