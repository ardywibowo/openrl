...
from openrl.pipelines import InferencePipeline
from openrl.trainers.arguments import TrainingArguments
from openrl.trainers.base_trainer import Trainer
from openrl.trainers.data_collator import (COLUMN_ACCEPT_ACTOR_SHIFTED_LOGPS,
...
class DPOPositiveTrainer(DeepSpeedPolicyTrainer):
    ...
    def get_checkpoints_of_this_iteration(self):
        from openrl.runtime import PolicyIterationRuntime
