...
from openrl.common import Lazy, logging_utils
from openrl.episode_generators import EpisodeGenerator
from openrl.episode_generators.base_episode_generator import \
    EpisodeGeneratorStrategy
from openrl.episode_generators.path_aggregators import PathAggregator
from openrl.episode_generators.path_filters import (PathFilter,
                                                      SuccessfulPathFilter)
from openrl.episode_generators.path_post_processors import PathPostProcessor
...
class TreeEpisodeGenerator(EpisodeGenerator, TreeEpisodeUtils):
    ...
    def convert_to_episode(
        ...
        tree = json.loads(instance["_openrl__reasoning_tree"])
