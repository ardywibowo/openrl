...
def parse_overrides(
    serialized_overrides: str, ext_vars: Optional[Dict[str, Any]] = None, import_callback: Any = None) -> Dict[str, Any]:
    if serialized_overrides:
        ext_vars = {**_environment_variables(), **(ext_vars or {})}

        return json.loads(evaluate_snippet("", serialized_overrides, ext_vars=ext_vars, import_callback=import_callback))
    else:
        return {}
...
class Params(MutableMapping):
    ...
    def pop(self, key: str, default: Any = DEFAULT, keep_as_dict: bool = False) -> Any:
        from openrl.common.from_params import ConfigurationError
