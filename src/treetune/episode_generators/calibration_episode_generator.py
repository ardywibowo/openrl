...
from treetune.tasks import Task, LinguisticCalibration
from treetune.tokenization_utils import Tokenizer

logger = get_logger(__name__)


@RewardFunction.register("linguistic_calibration_reward_function")
class LinguisticCalibrationRewardFunction(RewardFunction):
    def __init__(
        self,
        tokenizer: Tokenizer,
        ...
        assert isinstance(calibration_task, (LinguisticCalibration))
    ...
    def __call__(
        ...
        pred_answer = self.calibration_task.extract_predicted_answer_from_text(
        ...
        reward = self.calibration_task.grade_answer(
...
@EpisodeGenerator.register("linguistic_calibration_episode_generator")
class LinguisticCalibrationEpisodeGenerator(EpisodeGeneratorWithRewardFunction):
    def __init__(
        self,
